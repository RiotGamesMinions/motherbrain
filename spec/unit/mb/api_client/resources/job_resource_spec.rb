...
describe MB::ApiClient::JobResource do
  ...
  describe "#active" do
    it "performs a GET request to /jobs/active.json" do
      stub_request(:get, "http://0.0.0.0:1984/jobs/active.json").to_return(status: 200)
  ...
  describe "#list" do
    it "performs a GET request to /jobs.json" do
      stub_request(:get, "http://0.0.0.0:1984/jobs.json").to_return(status: 200)
  ...
  describe "#show" do
    ...
    it "performs a GET request to /jobs/{job_id}.json" do
      stub_request(:get, "http://0.0.0.0:1984/jobs/#{job_id}.json").to_return(status: 200)
